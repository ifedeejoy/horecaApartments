        ...
        var dtInvoice = dtInvoiceTable.DataTable({
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    width: '73px',
                    render: function(data, type, full, meta) {
                        var $expectedArrival = new Date(full['expected_arrival']);
                        // Creates full output for row
                        var $expectOutput =
                            '<span class="d-none">' +
...

                {
                    ...
                    render: function(data, type, full, meta) {
                        return (
                            ...
                            '<a class="mr-1" href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Checkin">' +
