...
<link rel="stylesheet" href="{{ secure_asset ('app-assets/vendors/css/tables/datatable/extensions/dataTables.checkboxes.css') }}">
...
@section('vendor-js')
    ...
    <script src="{{ secure_asset ('app-assets/vendors/js/tables/datatable/datatables.checkboxes.min.js') }}" defer></script>
...
@section('page-js')
    @parent
    <script src="{{ secure_asset('app-assets/js/scripts/pages/app-reservations-list.js')}}" defer></script>
