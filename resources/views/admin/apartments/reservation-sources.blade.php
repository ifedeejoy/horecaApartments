...
<link rel="stylesheet" href="{{ secure_asset ('app-assets/vendors/css/extensions/sweetalert2.min.css') }}">
@endsection

@section('page-css')
@parent
<link rel="stylesheet" href="{{ secure_asset ('app-assets/css/plugins/forms/form-validation.css') }}">
<link rel="stylesheet" href="{{ secure_asset ('app-assets/css/plugins/extensions/ext-component-sweet-alerts.css') }}">
...
@section('vendor-js')
    ...
    <script src="{{ secure_asset ('app-assets/vendors/js/extensions/sweetalert2.all.min.js') }}" defer></script>
@endsection

@section('page-js')
    <script src="{{ secure_asset('app-assets/js/scripts/pages/app-rates-list.js') }}" defer></script>
